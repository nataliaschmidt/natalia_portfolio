...
const projectsList: ProjectsType[] = [
  ...
  },
  {
    ...
    github: "https://github.com/nataliaschmidt/project-java-sistema-votacao.",
    isVIdeo: false,
  },
  {
    id: 14,
    ...
    video: "",
    description:
      "Neste projeto foi desenvolvido os princípios da arquitetura SOLID e os princípios de POO em uma estrutura de jogos de RPG (Role Playing Game)",
